...
import com.Alanjro_jr.util.ModelTable;
...
public class ControlPerson {
    ...
    public void delete(int id) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error deleting please try again or restate the system!");
        } finally {
            conecta.disconnect();
        }
    }
    ...
    public void editar(ModelPerson mod, int id) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error changing The data. Try again!");
        } finally {
            conecta.disconnect();
        }
    }
