...
////
    ...
    public RecognizeFace(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        recognizer.read("/Target/classifierLBPH.yml");
        recognizer.setThreshold(50); //the smaller the size,dificult to recognize...
        startCamera();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Initial Target Address");
        jPanel4.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 10, 200, -1));
        ...
        jLabel13.setText("RECOGNIZE TARGET FACE");
        ...
        jLabel7.setText("Main Camera is Monitorig");
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 0, 170, 20));
